...
**Software Development Engineer I** · [noon](https://www.noon.com) &nbsp;·&nbsp; <sub>Sept 2025 – Present</sub>
...
**Software Engineer Intern** · Incorta &nbsp;·&nbsp; <sub>Aug 2025 – Sept 2025</sub>
...
**Automation Engineer** · Everything to Gain <sub>(US startup)</sub> &nbsp;·&nbsp; <sub>Jul 2025 – Aug 2025</sub>
- Built an AI assistant bot — React frontend, FastAPI backend — for interactive real-time user support.
- Automated cross-platform integrations with Zapier and n8n, and designed HubSpot CRM workflows.

**Software Engineer Intern** · Applied Innovation Center (AIC–MCIT) &nbsp;·&nbsp; <sub>Aug 2024 – Sept 2024</sub>
- Cut frontend Docker build time from **14m 36s to 4m 47s (3×)** by optimizing the container and build pipeline.
...
**MSc, Natural Language Processing** — University of Alexandria, Faculty of Engineering &nbsp;·&nbsp; <sub>Sept 2025 – Present</sub>

**BE, Computer and Systems Engineering** — University of Alexandria, Faculty of Engineering &nbsp;·&nbsp; <sub>Sept 2020 – June 2025</sub>
CGPA **3.85 / 4.0** — graduated **5th in class**.

---

### Selected Work

**[JobSeeker](https://github.com/MostafaGalal1/JobSeeker)** — Microservice platform for semantic matching between résumés and job postings. Three services split by responsibility: résumé extraction and embedding, job-posting indexing, and vector-similarity search. Deployed on Kubernetes.
<sub>`Python` · `LangChain` · `Qdrant` · `RabbitMQ` · `Docker` · `K8s` · `Terraform`</sub>

**[WeatherHub](https://github.com/MostafaGalal1/WeatherHub)** — Real-time weather-station pipeline built around a **key-value store implemented from scratch** on the Bitcask model — append-only log, in-memory hash index, compaction. Kafka for ingest, Elasticsearch and Kibana for analytics, Parquet for cold storage.
<sub>`Java` · `Kafka` · `Elasticsearch` · `Docker` · `Kubernetes`</sub>

**[Secpar](https://github.com/MostafaGalal1/Secpar)** — CLI tool that scrapes competitive-programming submissions from Codeforces, CSES and Vjudge and archives them to GitHub with generated indexes. Scrapes **1,500 submissions in under 8 minutes**; published on PyPI with **8,000+ installations**.
<sub>`Python` · `PyPI` · `CLI`</sub>

**[claude-code-smart-router](https://github.com/MostafaGalal1/claude-code-smart-router)** — Provider-agnostic LLM tier router that classifies each request with a small model and dispatches it to the cheapest model that can handle it. Measured **70–85% cost reduction** across Anthropic, Gemini, OpenAI, OpenRouter, Groq, DeepSeek and Ollama.
<sub>`JavaScript` · `LLM infrastructure`</sub>

**[OLAP ETL with NiFi & Spark](https://github.com/MostafaGalal1/OLAP-ETL-with-Apache-NiFi-Spark)** — Pipeline converting an OLTP relational schema into an OLAP star schema, benchmarked against TPC-H with Parquet output.
<sub>`Python` · `NiFi` · `Spark` · `MySQL`</sub>

**[CSED25 Internships](https://github.com/MostafaGalal1/CSED25_Internships)** ![stars](https://img.shields.io/github/stars/MostafaGalal1/CSED25_Internships?style=flat-square&label=&color=555) — Community-maintained internship index for Computer Engineering students, and the most-used thing I've published.
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://streak-stats.demolab.com?user=MostafaGalal1&theme=github-dark-blue&hide_border=true&background=00000000">
    <img alt="GitHub contribution streak" height="170" src="https://streak-stats.demolab.com?user=MostafaGalal1&hide_border=true&background=00000000">
  </picture>
</p>
